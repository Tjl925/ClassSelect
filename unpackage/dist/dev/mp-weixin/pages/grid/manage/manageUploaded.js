        ...
        success: function(res) {
          ...
          if (res.tapIndex + 1 == 1) {
            ...
            if (currentTab === 0) {
              ...
              url = "/pages/community/modify_community?_id=" + id;
            }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
      ...
      return {
        a: common_vendor.f($data.Mycourse.slice(0, $data.pageSize), (item, index, i1) => {
          return {
            ...
            g: "1693ea52-2-" + i0 + "-" + i1 + "," + ("1693ea52-1-" + i0)
          };
        }),
        b: "1693ea52-1-" + i0 + ",1693ea52-0",
        c: "1693ea52-3-" + i0 + ",1693ea52-0",
        d: common_vendor.p({
          state: {
    ...
    f: common_vendor.sr("udbCourses", "1693ea52-0"),
      ...
      return {
        a: common_vendor.f($data.Mymaterials, (item, index, i1) => {
          return {
            ...
            f: "1693ea52-6-" + i0 + "-" + i1 + "," + ("1693ea52-5-" + i0)
          };
        }),
        b: "1693ea52-5-" + i0 + ",1693ea52-4",
        c: "1693ea52-7-" + i0 + ",1693ea52-4",
        d: common_vendor.p({
          state: {
    ...
    m: common_vendor.sr("udbMaterials", "1693ea52-4"),
      ...
      return common_vendor.e({
        a: common_vendor.f($data.Mypost, (item, k1, i1) => {
          return common_vendor.e({
            ...
            l: item._id,
            m: "1693ea52-10-" + i0 + "-" + i1 + "," + ("1693ea52-9-" + i0),
            n: common_vendor.p({
              direction: "column",
    ...
    t: common_vendor.sr("udb", "1693ea52-8"),
