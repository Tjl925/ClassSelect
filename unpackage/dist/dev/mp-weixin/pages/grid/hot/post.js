  ...
  methods: {
    ...
    getPosts() {
      return new Promise((resolve, reject) => {
        ...
        db.collection("community_post").orderBy("likes_count", "desc").limit(10).get().then((res) => {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        a: common_vendor.f($data.posts.slice(0, $data.pageSize), (item, k1, i1) => {
          return common_vendor.e({
            ...
            l: item._id,
            m: "111f3e6f-2-" + i0 + "-" + i1 + "," + ("111f3e6f-1-" + i0),
            n: common_vendor.p({
              direction: "column",
    ...
    c: common_vendor.sr("udb", "111f3e6f-0"),
