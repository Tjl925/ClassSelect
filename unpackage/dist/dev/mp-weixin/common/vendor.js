...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__E00B76E",
    appName: "Class_Select",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{\n    "address": [\n        "127.0.0.1",\n        "169.254.82.233",\n        "192.168.159.1",\n        "10.135.48.129"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "C:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), T = I('[{"provider":"aliyun","spaceName":"course-select","spaceId":"mp-55788fb7-2392-4142-8486-dfaba6fb925c","clientSecret":"/AjPs1p5+m05rbB9XjEezg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__E00B76E";
} catch (e2) {
