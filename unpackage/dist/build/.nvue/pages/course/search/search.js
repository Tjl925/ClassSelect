...
const _sfc_main = {
  ...
  methods: {
    clear(res) {
      formatAppLog("log", "at pages/course/search/search.nvue:178", "res: ", res);
    },
    confirm(res) {
    ...
    speech() {
      plus.speech.startRecognize({
        ...
        formatAppLog("error", "at pages/course/search/search.nvue:260", "语音识别错误: ", err);
      });
    },
    ...
    associativeClick(item) {
      formatAppLog("log", "at pages/course/search/search.nvue:303", "associativeClick: ", item);
