import { Z as Zs, f as formatAppLog, r as resolveEasycom, _ as __easycom_0, a as __easycom_1, b as __easycom_2, c as __easycom_3, d as __easycom_4 } from "../../../uni-list.js";
import { resolveDynamicComponent, openBlock, createElementBlock, createElementVNode, createVNode, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, withCtx } from "vue";
...
const _sfc_main = {
  ...
  methods: {
    clear(res) {
      formatAppLog("log", "at pages/community/search/search.nvue:182", "res: ", res);
    },
    confirm(res) {
    ...
    speech() {
      plus.speech.startRecognize({
        ...
        formatAppLog("error", "at pages/community/search/search.nvue:264", "语音识别错误: ", err);
      });
    },
    ...
    associativeClick(item) {
      formatAppLog("log", "at pages/community/search/search.nvue:308", "associativeClick: ", item);
      this.loadList(item.title);
    },
    loadList(text = "") {
      getApp().globalData.searchText = text;
      getApp().globalData.community_status = 1;
      uni.switchTab({
