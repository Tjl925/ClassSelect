...
const pages = [
  ...
  {
    path: "pages/community/search/search",
    style: {
      enablePullDownRefresh: true,
  ...
  {
    path: "pages/community/modify_community",
    style: {
      enablePullDownRefresh: true,
      navigationBarTitleText: "修改贴子"
    }
  },
  {
    path: "pages/community/modify_reply",
    style: {
      enablePullDownRefresh: true,
      navigationBarTitleText: "修改回复"
    }
  },
  {
    path: "pages/course/search/search",
    style: {
      navigationBarTitleText: "搜索"
    }
  },
  {
    path: "pages/material/create_material/create_material"
  },
  {
    path: "pages/course/create_course/create_course"
  },
  {
    path: "pages/material/search/search",
    style: {
      navigationBarTitleText: "搜索"
    }
  },
  ...
  {
    path: "pages/grid/manage/manageUploaded",
    style: {
      navigationBarTitleText: "选课通",
  ...
  {
    path: "pages/course/modify_course",
    style: {
      "app-plus": {
        titleNView: {
          buttons: [
      ...
      navigationBarTitleText: "修改课程信息"
    }
  },
  {
    path: "pages/material/modify_material",
    style: {
      "app-plus": {
        titleNView: {
          buttons: [
  ...
  {
    path: "pages/grid/hot/course"
  },
  {
    path: "pages/grid/hot/material"
  },
  {
    path: "pages/grid/hot/post"
  },
  {
  ...
  {
    path: "pages/ucenter/historicComments/historicComments",
    style: {
      navigationBarTitleText: "选课通"
    }
  },
  {
    path: "pages/ucenter/UpLoaded/UpLoaded",
    style: {
      navigationBarTitleText: "选课通",
      "onReachBottomDistance ": 10
    }
...
const subPackages = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        style: {
          navigationBarTitleText: "处理反馈",
          enablePullDownRefresh: false
        }
      },
      {
        path: "pages/opendb-report/opendb-report",
        style: {
          navigationBarTitleText: "提交举报",
          enablePullDownRefresh: false
        }
      },
      {
        path: "pages/opendb-report/list",
        style: {
          navigationBarTitleText: "查看举报",
          enablePullDownRefresh: false
        }
      },
      {
        path: "pages/opendb-report/detail",
        style: {
          navigationBarTitleText: "查看举报",
          enablePullDownRefresh: false
        }
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      selectedIconPath: "static/tabbar/material_active.png",
      text: "资料"
    },
    {
...
I("");
const T = I('[{"provider":"aliyun","spaceName":"course-select","spaceId":"mp-55788fb7-2392-4142-8486-dfaba6fb925c","clientSecret":"/AjPs1p5+m05rbB9XjEezg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__E00B76E";
} catch (e2) {
...
let Xs = new class {
  init(e2) {
    ...
    t2 = n2.init(e2), Ys(t2), Gn(t2), function(e3) {
...
const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["styles", [_style_0$4]]]);
...
const __easycom_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3]]);
        ...
        renderSlot(_ctx.$slots, "header", {}, () => [
          createElementVNode("view", { class: "uni-list-item__header" }, [
            $props.thumb ? (openBlock(), createElementBlock("view", {
              ...
              }, null, 8, ["customPrefix", "color", "type"])
            ])) : createCommentVNode("", true)
          ])
        ]),
...
const _style_0 = { "uni-list": { "": { "backgroundColor": "rgba(0,0,0,0)", "position": "relative", "flexDirection": "column" } }, "uni-list--border": { "": { "position": "relative", "borderTopColor": "#e5e5e5", "borderTopStyle": "solid", "borderTopWidth": 0.5, "borderBottomColor": "#e5e5e5", "borderBottomStyle": "solid", "borderBottomWidth": 0.5, "zIndex": -1 } } };
const _sfc_main = {
  name: "uniList",
  "mp-weixin": {
    options: {
